        ...
        <section className="layout-wrapper px-4 xl:px-0 my-10 md:my-12" style={{ marginTop: '100px', marginBottom: '0px' }}>
            <div className='max-w-screen-xl mx-auto'>
                <div className="flex md:justify-between justify-center items-center mb-2.5 md:mb-5">
                    <p className="font-bold text-sm md:text-[22px] text-gray-900 uppercase dm-bold">Furniture ZONE</p>
                    <a
                ...
                <div className="md:flex md:gap-5 gap-0">
                    <div className="md:w-[335px] lg:w-322p w-full pb-2">
                        <div className="relative h-600p w-full">
                            <img
                                className="w-full h-full object-cover neg-transition-scale rounded-md"
                                src="https://demo.martvill.techvill.net/public/uploads/20221203/4549648a85ebfff095bba62a585ddf9b.webp"
                                alt="Image"
                            />
                            ...
                            <div>
                                <div className="border rev-img mainflash-1 rounded-md relative product-hover">
                                    <div className="h-48 flex justify-center items-center">
                                        ...
                                        <a href="https://demo.martvill.techvill.net/products/waist-straight-slouchy-jeans" className="w-full h-full z-10">
                                            <img className="w-full h-full object-cover rounded-md neg-transition-scale" src="https://demo.martvill.techvill.net/public/uploads/sizes/medium/20221123/3e2bd32693086adee813af0977d00ede.webp" alt="Image" />
                                        </a>
                                    </div>
                                    <div className=" absolute top-2.5 left-2.5 right-2.5">
                                        <p className="primary-bg-color relative z-30 h-18p w-max justify-center text-white px-2 flex items-center rounded-sm mb-2.5 leading-3 roboto-medium font-medium text-xss whitespace-nowrap">
                                            Featured
                                        </p>
                                        <p className="primary-bg-color h-4 w-max relative text-gray-12 mb-2.5 px-2 py-1 flex items-center justify-center rounded-sm leading-3 roboto-medium font-medium z-30 text-8 whitespace-nowrap uppercase">
                                            33.33% off
                                        </p>
                                    </div>
                                        ...
                                        <div className="w-full h-full hover-icon absolute top-0">
                                            <div className="w-full h-full flex justify-end cursor-pointer pt-15p ltr:pr-15p rtl:pl-15p">
                                                <div slot="icon" className="relative">
                                                    ...
                                                    <div data-id="1199" className="z-20 wishlist h-6 w-6 p-1 mb-2 text-gray-12 relative primary-bg-hover border border-gray-2 rounded-full bg-white add-wishlist">
                                                    ...
                                                    <div data-itemid="1199" className="z-20 h-6 w-6 p-1 absolute mb-2 text-gray-12 bg-white primary-bg-hover border border-gray-2 rounded-full compare-bg neg-transition-scale add-to-compare">
                                                ...
                                                <button className="open-view-modal" data-itemcode="OHUf3UPUH4MIWl8">
                                                    <p className="text-gray-12 font-medium py-1 absolute bottom-0 inset-x-0 rounded rounded-t-none text-center text-11 primary-bg-color z-20">
                                                        Quick View
                                                    </p>
                                                </button>
                                            </div>
                                ...
                                <div className="sm:text-center flex flex-col">
                                    <a href="https://demo.martvill.techvill.net/products/waist-straight-slouchy-jeans">
                                        <p className="text-13 md:text-sm text-gray-12 md:mt-2 dm-regular line-clamp">Waist straight Slouchy jeans</p>
                                    </a>
                            ...
                            <div>
                                <div className="border rev-img mainflash-1 rounded-md relative product-hover">
                                    <div className="h-48 flex justify-center items-center">
                                        ...
                                        <a href="https://demo.martvill.techvill.net/products/waist-straight-slouchy-jeans" className="w-full h-full z-10">
                                            <img className="w-full h-full object-cover rounded-md neg-transition-scale" src="https://demo.martvill.techvill.net/public/uploads/sizes/medium/20221123/6b2f904f2fafb2b96388290860425dd0.webp" alt="Image" />
                                        </a>
                                    </div>
                                    <div className=" absolute top-2.5 left-2.5 right-2.5">
                                        <p className="primary-bg-color relative z-30 h-18p w-max justify-center text-white px-2 flex items-center rounded-sm mb-2.5 leading-3 roboto-medium font-medium text-xss whitespace-nowrap">
                            ...
                            <div>
                                <div className="border rev-img mainflash-1 rounded-md relative product-hover">
                                    <div className="h-48 flex justify-center items-center">
                                        ...
                                        <a href="https://demo.martvill.techvill.net/products/waist-straight-slouchy-jeans" className="w-full h-full z-10">
                                            <img className="w-full h-full object-cover rounded-md neg-transition-scale" src="https://demo.martvill.techvill.net/public/uploads/sizes/medium/20221123/026b90fc64033306bc721aae8f2fd6c4.webp" alt="Image" />
                                        </a>
                                    </div>
                                    <div className=" absolute top-2.5 left-2.5 right-2.5">
                                        <p className="primary-bg-color relative z-30 h-18p w-max justify-center text-white px-2 flex items-center rounded-sm mb-2.5 leading-3 roboto-medium font-medium text-xss whitespace-nowrap">
