        ...
        <>
            <div className='flex flex-col sm:flex-row gap-5 items-start '>
                    ...
                    <div className='invisible group-hover:visible absolute inset-0 p-1 z-20 ease-in-out duration-300'>
                        ...
                        <div className="w-full h-full flex justify-end cursor-pointer pt-15p ">
                            <div className="relative flex flex-col gap-2">
                                ...
                                <button onClick={toggleFav} className="h-6 w-6 flex justify-center items-center p-1  text-gray-400 relative hover:bg-primary hover:text-white border border-gray-300 rounded-full bg-white">
                ...
                <div className="sm:text-left flex flex-col">
                    ...
                    <h2 className="text-xl font-dm font-medium text-left"><Link  href={`/product/${id}`} className='text-gray-700 hover:text-primary ease-in-out duration-200'>{name}</Link></h2>
