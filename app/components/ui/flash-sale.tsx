            ...
            <div className="md:flex md:gap-5 gap-0">
                <div className="md:w-322p w-full">
                    <div className="relative bg-gray-11 rounded-md pb-0.5">
                        <div className="p-4">
                            <p className="text-xs rounded-sm font-medium text-gray-12 text-center px-1.5 py-1 primary-bg-color inline">
                                Deal Of The Day
                            </p>
                        </div>
                        <div className="flex justify-center">
                            <img width="180px" height="160px" src="https://demo.martvill.techvill.net/public/uploads/20221120/abc930448a9f08de458b70e58e9f894e.webp" alt="Image" />
                        </div>
                            ...
                            <div className="border rev-img mainflash-1 rounded-md relative product-hover">
                                <div className="h-48 flex justify-center items-center">
                                    ...
                                    <a href="https://demo.martvill.techvill.net/products/waist-straight-slouchy-jeans" className="w-full h-full z-10">
                                        <img className="w-full h-full object-cover rounded-md neg-transition-scale" src="https://demo.martvill.techvill.net/public/uploads/sizes/medium/20221120/abc930448a9f08de458b70e58e9f894e.webp" alt="Image" />
                                    </a>
                                </div>
