...
export const Shigninsignup: React.FC<signinup> = ({onClick}) => {
  ...
  return (
    <>
      ...
      <div className={`fixed z-50 inset-0 flex justify-center items-center p-10 `} >
        <div onClick={onClick} className={`fixed inset-0 bg-black/50 ease-in-out duration-200 `} />
        <section className={`relative z-10 w-full p-5 max-w-lg bg-white rounded overflow-auto max-h-[calc(100vh-100px)]`}  >
