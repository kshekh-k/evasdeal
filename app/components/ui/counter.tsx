...
const Counter: React.FC<counter> = ({min, max, value, onChange}) => {
    ...
    return (
        <div className="flex relative w-32">            
            <Input type="text" className='px-12 text-center !text-lg !py-1.5' value={count} min={min} max={max} onChange={onChange} />
